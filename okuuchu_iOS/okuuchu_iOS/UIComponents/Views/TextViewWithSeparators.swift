...
class TextViewWithSeparators: UIView {
    ...
    func onConfigureView(){
        ...
        textLabel.text = """
        Колдонмо ылайыктуу репетиторлорду жана студенттерди оңой жана тез табуу үчүн иштелип чыккан.

        Колдонмодо издөө тутуму орнотулган, анда окуучулар ылайыктуу тарбиячыны табуу үчүн чыпканы орното алышат
        """
